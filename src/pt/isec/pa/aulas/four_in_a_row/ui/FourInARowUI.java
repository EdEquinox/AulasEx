package pt.isec.pa.aulas.four_in_a_row.ui;
...
import pt.isec.pa.aulas.four_in_a_row.model.FourInARowManager;
        ...
        try (   Terminal terminal = new DefaultTerminalFactory().createTerminal();
            ...
            while (!game.isFull() && (winner = game.checkWinner()) == null) {
                ...
                if (25-dim[0] > 5) {
                    ...
                    terminal.putString("Press a column number or 'q' to quit.");
                    terminal.flush();
